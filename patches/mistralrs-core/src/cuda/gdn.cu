...
#ifndef CRYTEX_GDN_DISABLE_RECURRENCE
...
#pragma unroll
  for (int j = 0; j < BK; j++) {
    s[j] = has_v ? state_bh[j * v_dim + v_idx] : 0.0f;
  }
...
#endif // CRYTEX_GDN_DISABLE_RECURRENCE
...
#ifndef CRYTEX_GDN_DISABLE_CHUNKED_RECURRENCE

#ifndef CRYTEX_GDN_DISABLE_CHUNKED_PREFILL_OPTIMIZATION
...
#endif // CRYTEX_GDN_DISABLE_CHUNKED_PREFILL_OPTIMIZATION
...
#endif // CRYTEX_GDN_DISABLE_CHUNKED_RECURRENCE
...
#ifndef CRYTEX_GDN_DISABLE_CAUSAL_CONV
...
#endif // CRYTEX_GDN_DISABLE_CAUSAL_CONV
...
#ifndef CRYTEX_GDN_DISABLE_FUSED_GATING
...
#endif // CRYTEX_GDN_DISABLE_FUSED_GATING
